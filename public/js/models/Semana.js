...
export default class Semana {
    ...
    constructor(
        ...
        this.numeros = Array.isArray(numeros)
            ? numeros.map(Number)
            : [];

        this.cantidad = this.numeros.length;
