...
export default class ControlOperativoResultados {
    ...
    recombinarResultadosConInversion(
        resultados = [],
        pesos = {},
        motoresInvertidos = []
    ) {
        ...
        return (
            ...
            original => {
                ...
                const resultadosMotores =
                    salida?.resultados &&
                    typeof salida.resultados === "object"
                        ? salida.resultados
                        : {};

                let sumaAportes = 0;
                let sumaPesosEfectivos = 0;
                let sumaConfianzaPonderada = 0;
                let sumaPesosRaw = 0;
                let sumaScoreRaw = 0;
                let sumaPesosScoreRaw = 0;

                const detallePesos = [];

                for (
                    const [clave,item]
                    of Object.entries(resultadosMotores)
                ) {
                    ...
                    const pesoEfectivo =
                        peso * factorConfianza;

                    const aporte =
                        score * pesoEfectivo;

                    sumaAportes += aporte;
                    sumaPesosEfectivos += pesoEfectivo;
                    sumaConfianzaPonderada += confianza * peso;
                    sumaPesosRaw += peso;
                    sumaScoreRaw += score * peso;
                    sumaPesosScoreRaw += peso;

                    resultadosMotores[clave] = {
                        ...item,
                        scoreOriginal,
                        score,
                        invertido:
                    ...
                    detallePesos.push({
                        ...
                        peso,
                        factorConfianza:
                            Number(factorConfianza.toFixed(6)),
                        pesoEfectivo:
                            Number(pesoEfectivo.toFixed(6)),
                        aporte:
                            Number(aporte.toFixed(6))
                    });
                }
                ...
                salida.pesoTotal =
                    Number(
                        sumaPesosEfectivos.toFixed(6)
                    );

                salida.transformacionDiagnostica = {
                    tipo:
                        "INVERSION_SCORE_100_MENOS_SCORE",
                    motoresInvertidos:
                        [...invertir]
                };
    ...
    generarPrediccionTemporalConInversion({
        historial,
        estadisticas,
        pesos,
        semanaObjetivo,
        ...
        const MotorRankingTemporal =
            this.entorno.motorRanking?.constructor;

        if (
            typeof MotorManagerTemporal !== "function" ||
            typeof MotorRankingTemporal !== "function"
        ) {
            throw new Error(
                "No están disponibles los constructores temporales de MotorManager y MotorRanking."
            );
        }
        ...
        const resultadosTransformados =
            this.recombinarResultadosConInversion(
        ...
        const rankingMotor =
            new MotorRankingTemporal();

        const ranking =
            rankingMotor.generar(
                resultadosTransformados,
                {}
            );

        const prediccion =
            rankingMotor.prepararPrediccion(
                ranking,
                {
                    semanaObjetivo,
                    fechaObjetivo,
    ...
    resumirComparacionEstrategiasWalkForward(
        filas,
        resumenBase,
        auditoriaAblacion,
        auditoriaInversion
                ...
                .map(
                    estrategia => {
                        ...
                        for (
                            ...
                            if (deltaTop20 > 0) ganaTop20++;
                            else if (deltaTop20 < 0) pierdeTop20++;
                            else empataTop20++;
    ...
    obtenerVariantesInversionWalkForward() {

        return [
            {
                id: "INVERTIR_TENDENCIA",
                invierte: ["tendencia"]
            },
            {
                id: "INVERTIR_FRECUENCIA",
                invierte: ["frecuencia"]
            },
            {
                id: "INVERTIR_HISTORICO",
                invierte: ["historico"]
            },
            {
                id: "INVERTIR_TENDENCIA_FRECUENCIA",
                invierte: [
                    "tendencia",
                    "frecuencia"
                ]
            ...
            {
                id: "INVERTIR_TENDENCIA_FRECUENCIA_HISTORICO",
                invierte: [
                    "tendencia",
                    "frecuencia",
                    "historico"
    ...
    resumirInversionWalkForward(
        ...
        const resultados =
            (variantes ?? [])
                    ...
                    variante => {
                        ...
                        return {
                            ...
                            deltaTop10VsBase:
                                Number(
                                    (
                                        resumen.promedioAciertosTop10 -
                                        resumenBase.promedioAciertosTop10
                                    ).toFixed(4)
                                ),
                            deltaTop20VsBase:
                                Number(
                                    (
                                        resumen.promedioAciertosTop20 -
                                        resumenBase.promedioAciertosTop20
                                    ).toFixed(4)
                                ),
                            deltaOrdenVsBase:
                                Number(
                                    (
                                        resumenBase.promedioOrdenGlobal -
                ...
                .sort(
                    (a,b)=>
                        Number(b.deltaOrdenVsBase) -
                        Number(a.deltaOrdenVsBase)
                );

        return {
            esquema:
                "INVERSION_CONTRAFACTUAL_WALK_FORWARD_V1",
            versionControl:
                this.version,
            naturaleza:
            ...
            validacionPredictiva:
                false,
            transformacion:
                "scoreTransformado = 100 - scoreOriginal",
            advertencia:
                "La inversión se prueba sobre los mismos folds usados para detectar la orientación inversa. Una mejora confirma coherencia interna de la hipótesis, pero no constituye validación predictiva independiente.",
            variantes:
                resultados
        };
    }
    ...
    async ejecutarBacktestWalkForward({
        ...
        try {
            ...
            const variantesInversion =
                this.obtenerVariantesInversionWalkForward();
            ...
            for (
                ...
                for (
                    const varianteInversion
                    of variantesInversion
                ) {

                    const predInversion =
                        this.generarPrediccionTemporalConInversion({
                            historial:
                                pasado,
                            estadisticas,
                            pesos:
                            ...
                            fechaObjetivo:
                                objetivo?.fecha ?? null,
                            variante:
                                `WALK_FORWARD_INVERSION_${varianteInversion.id}`,
                            escenarioId:
                                `wf_inv_${varianteInversion.id}_${semanaObjetivo}`,
                            motoresInvertidos:
                                varianteInversion.invierte
                        });

                    inversiones[
                        varianteInversion.id
                    ] =
                        this.evaluarPrediccionWalkForward(
                            predInversion,
                            objetivo?.numeros
            ...
            const auditoriaInversion =
                this.resumirInversionWalkForward(
                    filas,
                    variantesInversion,
                    resumenBase
                );

            const comparacionEstrategias =
                this.resumirComparacionEstrategiasWalkForward(
                    filas,
                    resumenBase,
                    auditoriaAblacion,
                    auditoriaInversion
        ...
        contenedor.innerHTML = `
            <div class="walk-forward">
                ...
                <div class="walk-forward__comparacion-estrategias">
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>Orden</th>
                                <th>Δ orden</th>
                                <th>Orden gana/pierde/empata</th>
                                <th>Tasa mejora orden</th>
                                <th>T20 gana/pierde/empata</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${
                                (
                                    ...
                                    .map(x=>`
                                        <tr>
                                            ...
                                            <td>${x.orden.gana}/${x.orden.pierde}/${x.orden.empata}</td>
                                            <td>${Number((x.orden.tasaMejora * 100).toFixed(2))}%</td>
                                            <td>${x.top20.gana}/${x.top20.pierde}/${x.top20.empata}</td>
                                        </tr>
                                    `)
                                    .join("")
                            }
                    ...
                    <small>
                        Esta comparación usa exactamente las mismas ventanas
                        para cada estrategia. Una mejora consistente en muchas
                        ventanas es más informativa que una sola media global,
                        pero sigue siendo diagnóstico interno y no un holdout independiente.
                    </small>
                </div>

                <div class="walk-forward__inversion">
                    <div class="walk-forward__estadistica-cabecera">
                        <strong>Inversión contrafactual de scores</strong>
                        <span>score → 100 − score · solo diagnóstico</span>
                    </div>
                            ...
                            ${
                                (
                                    ...
                                    .map(x=>`
                                        <tr>
                                            <td>${this.escapeHTML(x.id)}</td>
                                            <td>${this.escapeHTML((x.invierte ?? []).join(", "))}</td>
                                            <td>${x.promedioAciertosTop10}</td>
                    ...
                    <small>
                        Mantiene los mismos pesos base y solamente invierte
                        temporalmente el score de los motores indicados.
                        No modifica MotorManager, Firestore ni la configuración activa.
                        Esta prueba sigue siendo exploratoria sobre los mismos folds.
                    </small>
                </div>
            ...
            <div class="resultado-simulacion">
                ...
                <div class="laboratorio-escenarios">
                    <div class="laboratorio-escenarios__intro">
                        <div>
                            <strong>
                                Laboratorio de Escenarios · v3.2.0
                            </strong>
                            <p>
                    ...
                    <div class="banco-escenarios">
                        <div class="banco-escenarios__intro">
                            <div>
                                <strong>
                                    Banco de Escenarios Reproducible · v3.2.0
                                </strong>
                                <p>
                    ...
                    <div class="walk-forward-panel">
                        <div class="walk-forward-panel__intro">
                            <div>
                                <strong>
                                    Backtest Técnico Walk-Forward · v3.2.0
                                </strong>
                                <p>
